<?php defined('BASEPATH') OR exit('No direct script access allowed');
	Class Pesanan_cust extends Admin_Controller {
		...
		public function index(){
			...
			$this->data['link']	= "#";
			$this->data['box_title'] = "Histori Pesanan Customer Bulan ".$this->bulan[date("m") - 1]." ".date("Y");
			...
			$histori = $this->db->get("motif_keluar_detail");
		...
		public function pilih_cust(){
			...
			$this->db->order_by("tanggal","desc");
			$histori = $this->db->get("motif_keluar");
