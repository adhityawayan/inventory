	...
	<div class='col-xs-5' id="">
		<div class="box">
			<div class="box-header">
				<h3 class="box-title">Laporan Pejualan</h3>

			</div>
			<form action="<?php echo site_url("laporan/penjualan/tahun"); ?>" method="post">
		...
		<div class="box">
			<div class="box-header">
				...
				<div class="box-tools pull-right">
	                ...
	                <a href="<?php echo site_url('laporan/penjualan'); ?>"  class="btn btn-default"><i class="fa fa-cancel"></i> Batal</a>
	              </div>
			</div>
			<div class="box-body">
