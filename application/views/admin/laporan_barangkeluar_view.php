...
<div class='row'>
	<div class='col-xs-5' id="">
		<div class="box">
			...
			<form action="<?php echo site_url("laporan/motif_keluar/harian"); ?>" method="post">
			<div class="box-body">
	...
	<div class='col-xs-5' id="">
		<div class="box">
			...
			<form action="<?php echo site_url("laporan/motif_keluar/bulanan"); ?>" method="post">
		...
		<div class="box">
			<div class="box-header">
				...
				<div class="box-tools pull-right">
	                ...
	                <a href="<?php echo site_url('laporan/motif_keluar'); ?>"  class="btn btn-default"><i class="fa fa-cancel"></i> Batal</a>
	              </div>
			</div>
			<div class="box-body">
